# Manual de Usuario Specification

## Purpose

In-app interactive tutorial system for the Kachorros veterinary clinic webapp. Provides role-scoped, step-by-step guided tours with annotated screenshots and interactive hotspots. Accessible from the sidebar by all authenticated roles.
